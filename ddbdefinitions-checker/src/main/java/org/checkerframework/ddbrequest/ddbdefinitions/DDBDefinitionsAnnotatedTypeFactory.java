...
public class DDBDefinitionsAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
    ...
    protected Set<Class<? extends Annotation>> createSupportedTypeQualifiers() {
        return new LinkedHashSet<>(
                Arrays.asList(
                        DDBDefinitionsTop.class,
                        DDBDefinitionsBottom.class,
                        DDBDefinitions.class));
    }

    @Override
    public TreeAnnotator createTreeAnnotator() {
        return new ListTreeAnnotator(new DDBDefinitionsTreeAnnotator(this), super.createTreeAnnotator());
    }
    ...
    private class DBBExpressionsQualifierHierarchy extends MultiGraphQualifierHierarchy {
        ...
        public AnnotationMirror greatestLowerBound(AnnotationMirror a1, AnnotationMirror a2) {
            if (AnnotationUtils.areSameByClass(a1, DDBDefinitionsTop.class)) {
                ...
                List<String> a1Values = AnnotationUtils.getElementValueArray(a1,
                        "values", String.class, true);
                List<String> a1Names = AnnotationUtils.getElementValueArray(a1,
                        "names", String.class, true);
                List<String> a2Values = AnnotationUtils.getElementValueArray(a2,
                        "values", String.class, true);
                List<String> a2Names = AnnotationUtils.getElementValueArray(a2,
                        "names", String.class, true);
        ...
        public boolean isSubtype(AnnotationMirror subtype, AnnotationMirror supertype) {
            if (AnnotationUtils.areSameByClass(subtype, DDBDefinitionsBottom.class)
                ...
                List<String> subValues = AnnotationUtils.getElementValueArray(subtype,
                        "values", String.class, true);
                List<String> subNames = AnnotationUtils.getElementValueArray(subtype,
                        "names", String.class, true);
                List<String> superValues = AnnotationUtils.getElementValueArray(supertype,
                        "values", String.class, true);
                List<String> superNames = AnnotationUtils.getElementValueArray(supertype,
                        "names", String.class, true);
     ...
     */
    public AnnotationMirror createDDBDefinitions(Collection<String> names, Collection<String> values) {
        ...
        public Void visitMethodInvocation(MethodInvocationTree tree, AnnotatedTypeMirror type) {
            ...
            if (ddbUtils.isKnownReturnsReceiverMethod(tree)) {
                ...
                if (ddbUtils.isNamesSetter(tree, processingEnv)) {
                    List<String> values =  AnnotationUtils.areSame(receiverAnno, top) ? new ArrayList<>()
                            : AnnotationUtils.getElementValueArray(receiverAnno, "values", String.class, true);
                    Tree namesExpr = tree.getArguments().get(0);
                    ConstantKeysAnnotatedTypeFactory ckatf = getTypeFactoryOfSubchecker(ConstantKeysChecker.class);
                    ...
                    List<String> names = ckAnno == null ? new ArrayList<>()
                    ...
                    List<String> names =  AnnotationUtils.areSame(receiverAnno, top) ? new ArrayList<>()
                    ...
                    AnnotationMirror ckAnno = ckType.getAnnotation(ConstantKeys.class);
                    List<String> values = ckAnno == null ? new ArrayList<>()
                            : AnnotationUtils.getElementValueArray(ckAnno, "value", String.class, true);
                    type.replaceAnnotation(createDDBDefinitions(names, values));
                } else {
