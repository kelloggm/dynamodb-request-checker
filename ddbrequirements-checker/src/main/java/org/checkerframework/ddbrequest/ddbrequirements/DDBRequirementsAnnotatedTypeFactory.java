...
public class DDBRequirementsAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
    ...
    protected Set<Class<? extends Annotation>> createSupportedTypeQualifiers() {
        return new LinkedHashSet<>(
                Arrays.asList(
                        DDBRequirementsBottom.class,
                        DDBRequirementsTop.class,
                        DDBRequirements.class));
    }

    @Override
    public TreeAnnotator createTreeAnnotator() {
        return new ListTreeAnnotator(new DDBRequirementsTreeAnnotator(this), super.createTreeAnnotator());
    }
     ...
     */
    public AnnotationMirror createDDBRequirements(Collection<String> names, Collection<String> values) {
                ...
                if (ddbUtils.isExpressionMethodCall(tree, processingEnv)) {
                    ...
                    if (stringVal != null) {
                        ...
                        if (values.size() == 1) {
                            ...
                            AnnotationMirror newReceiverAnno = getQualifierHierarchy()
