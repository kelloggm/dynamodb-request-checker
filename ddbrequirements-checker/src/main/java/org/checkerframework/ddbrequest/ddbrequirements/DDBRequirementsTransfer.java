...
public class DDBRequirementsTransfer extends CFTransfer {
  ...
  public TransferResult<CFValue, CFStore> visitMethodInvocation(
    ...
    if (annotatedTypeFactory.ddbUtils.isExpressionMethodCall(
        node, annotatedTypeFactory.getProcessingEnv())) {
      ...
      if (stringVal != null) {
        ...
        if (values.size() == 1) {
          ...
          while (receiver != null) {
            ...
            if (annotatedTypeFactory.ddbUtils.isExpressionMethodCall(
                receiverAsMethodInvocation, annotatedTypeFactory.getProcessingEnv())) {
